...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/ui/select'; // Import the Select components
...
export default function Notifications({ notifications: initialNotifications }: PageProps) {
    ...
    const handleFilterChange = (newFilter: 'all' | 'unread') => {
        ...
        router.visit('/notifications', {
            ...
            preserveState: true,
            preserveScroll: true,
            only: ['notifications', 'flash', 'filter', 'sort'],
        });
    };
                                    ...
                                    <DialogTrigger asChild>
                                        ...
                                        >
                                            <div className="flex flex-1 items-center gap-3">
                                                ...
                                                <div className="flex flex-1 items-center gap-3">
                                                    <UserInfo user={notification.user} showEmail={true} />
                                                    <div className="flex-1">
                                                        <p
                                                        ...
                                                        <p className="text-muted-foreground text-xs">{notification.relativeTime}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
