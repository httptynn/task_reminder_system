...
//     initialEvents?: Event[]; // Optional prop to pass events from parent
// }

// export default function FullCalendarComponent({ initialEvents = [] }: FullCalendarComponentProps) {
...
//                 events={events}
//                 eventColor="#3788d8" // Optional: Customize event color
//                 height="100%" // Ensure it fills the container height
//                 contentHeight="auto" // Adjust content height dynamically
//                 headerToolbar={{
//                     left: 'prev,next today',
//                     center: 'title',
//                     right: 'dayGridMonth,dayGridWeek,dayGridDay', // Add week view option
//                 }}
//                 eventClick={(info) => {
//                     // Optional: Handle event click (e.g., show details)
